module.exports = {
    ...
    rules: {
        'no-useless-escape': 0, // 多余的反斜杠警告
        'no-undef': 0,
        '@typescript-eslint/no-explicit-any': 0,
        'vue/multi-word-component-names': 'off', // 关闭template根元素划红线
        ...
        'brace-style': ['error', '1tbs', { allowSingleLine: false }], // if/elseif/else左花括号要跟if..同行，右花括号要换行；或者全部同一行
        ...
        'function-paren-newline': 0, // 强制函数括号内的参数一致换行或一致不换行
        // 'implicit-arrow-linebreak': 'error', // 禁止箭头函数的隐式返回 在箭头函数体之前出现换行
        indent: 'off',
        '@typescript-eslint/indent': ['error', 4], // 使用一致的缩进，4个空格
        ...
        'newline-per-chained-call': ['error', { ignoreChainWithDepth: 10 }], // 链式调用长度超过2时，强制要求换行
        ...
        'object-curly-newline': [0, { multiline: true }], // 对象数属性要有一致的换行，都换行或都不换行
