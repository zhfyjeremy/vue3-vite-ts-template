    ...
    private interceptorsResponse() {
        ...
        this.service.interceptors.response.use(
            async (response: AxiosResponse) => {
                ...
                this.isCallbackAll = IS_CALLBACK_ALL
            ...
            (error: AxiosError) => {
                ...
                this.isCallbackAll = IS_CALLBACK_ALL
                // 根据响应的错误状态码，做不同的处理
                if (response) return checkStatus(response)
